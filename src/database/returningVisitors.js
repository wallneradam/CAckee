...
const aggregateReturningVisitors = require('../aggregations/aggregateReturningVisitors')
const aggregateNewVisitors = require('../aggregations/aggregateNewVisitors')
...
const getReturningVisitors = async (ids, interval, limit, dateDetails) => {
	const aggregation = aggregateReturningVisitors(ids, interval, limit, dateDetails)
		...
		return createArray(limit).map((_, index) => {
			...
			const entry = entries.find((entry) => {
				return matchesDate(
					...
					undefined, // no month in returning visitors aggregation
...
const getNewVisitors = async (ids, interval, limit, dateDetails) => {
	const aggregation = aggregateNewVisitors(ids, interval, limit, dateDetails)
