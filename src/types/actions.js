...
module.exports = gql`
	...
	input CreateActionInput {
		"""
		Anonymous per-site visitor identifier generated by the tracker. Allows the UI to show how many unique visitors triggered an action.
		"""
		vid: String
		"""
	...
	type Mutation {
		"""
		Create a new action to track an event. Pass the optional domainId to allow filtering the event statistics by domain.
		"""
		createAction(eventId: ID!, domainId: ID, input: CreateActionInput!): CreateActionPayload!
		"""
